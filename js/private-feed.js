...
(function(){
  ...
  const POSTS = [
    {
      id: 'p-2025-09-16-1',
      date: '2025-09-16T12:05:00+03:00',
      text: 'Новый формат: личная стена как в X. Все приватные мысли — в одном месте.',
      images: []
    },
    {
      id: 'p-2025-09-15-1',
      date: '2025-09-15T20:10:00+03:00',
      text: 'Тестирую приватную ленту. Простая подача, без шума.',
      images: ['https://images.unsplash.com/photo-1521579971123-1192931a1452?q=80&w=1400&auto=format&fit=crop']
    },
    {
      id: 'p-2025-09-15-2',
      date: '2025-09-15T10:20:00+03:00',
      text: 'Apple Watch Ultra 3: держит дольше, читается лучше. В спорт‑режимах — зверь.',
      images: [
        'https://www.apple.com/v/apple-watch-ultra-3/a/images/overview/product-viewer/product_durability__fjxsjypa2e6i_large_2x.jpg',
        'https://www.apple.com/v/iphone-air/a/images/overview/welcome/hero_endframe__e89wrlp1kjee_xlarge_2x.jpg'
      ]
    },
    {
      id: 'p-2025-09-14-1',
      date: '2025-09-14T18:45:00+03:00',
      text: 'Дизайн‑заметка: большие заголовки + воздух дают ритм и уверенность в интерфейсе.',
      images: []
    },
    {
      id: 'p-2025-09-13-1',
      date: '2025-09-13T09:00:00+03:00',
      text: 'Режим дня: редактура → прототипы → тесты. Детали строят ощущение «аккуратно сделано».',
      images: []
    },
    {
      id: 'p-2025-09-12-1',
      date: '2025-09-12T22:10:00+03:00',
      text: 'iPhone 17 Pro: цельный корпус, мощность, автономность.',
      images: ['https://www.apple.com/v/iphone-17-pro/a/images/overview/welcome/hero_endframe__xdzisdq1ppem_xlarge_2x.jpg']
    }
  ];
